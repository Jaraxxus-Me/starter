...
![workflow](https://github.com/Jaraxxus-Me/starter/actions/workflows/ci.yml/badge.svg)
...
### Set Up the Code
2. **Clone this repository** and give it the name of your repo: `git clone git@github.com:Jaraxxus-Me/starter.git <NAME>`. You now have a directory called NAME. **Enter** it: `cd <NAME>`.
